...
MERGE INTO user_info 
  USING (SELECT sub, preferred_username, name, email, email_verified, eye_color FROM user_info_TEMP) AS vals(sub, preferred_username, name, email, email_verifiedi, eye_color)
